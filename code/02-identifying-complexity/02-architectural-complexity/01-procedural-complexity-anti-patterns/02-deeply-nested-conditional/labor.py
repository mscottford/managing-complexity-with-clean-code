# The `_sample_labor` function below was extracted from the `dgl` project,
# specifically from `python/dgl/sampling/labor.py`. It was retrieved from
# https://github.com/dmlc/dgl/blob/69a532c1aba4bac714cce6746b610ba2b20b835c/python/dgl/sampling/labor.py#L244-L356
# on July 24, 2023.

# This function contains many deeply nested conditionals that make it a good
# target for refactoring.

# The license that this code was published under appears at the bottom of this
# file.
...
# The following license was extraced from https://github.com/dmlc/dgl/blob/69a532c1aba4bac714cce6746b610ba2b20b835c/LICENSE.
